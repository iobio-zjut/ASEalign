...
void tql2(float **V, float *d, float *e, int NDIM)
{
	...
	//xxy修改
	FILE* fpWrite = fopen("/share/home/zhanglab/xxy/meta_contact/test_291/test_fix1_291/num.txt", "a+");
	fprintf(fpWrite, "%d\n", a);
	printf("a====%d\n", a);
	for (i = a; i < NDIM; i++) {
		d[i] = 0;
...
#else
	    strcpy(tdbname, "/share/home/zhanglab/xxy/Threader/Engerthread/database/AFDB_20W/tdb_eig_fix1/");
#endif
